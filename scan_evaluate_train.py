...
for epoch in range(start_epoch, p['epochs']):
    ...
    print('Adjusted learning rate to {:.5f}'.format(lr))
        ...
        # Train
    print('Train ...')
    c_loss = train_one_epoch(train_loader=batch_loader, model=model, criterion=first_criterion, optimizer=optimizer, epoch=epoch, train_args=p['train_args'], second_criterion=second_criterion)
